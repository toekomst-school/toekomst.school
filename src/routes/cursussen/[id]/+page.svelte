          ...
          <div class="cursus-lessons-list">
            {#each lessons as lesson}
              <div class="cursus-lesson-row">
                <a href={`/lessen/${lesson.$id}`} class="cursus-lesson-link">{lesson.onderwerp || 'Les zonder titel'}</a>
                <span class="cursus-lesson-nr">Lesnummer: {lesson.lesnummer}</span>
                <button class="remove-btn" on:click={() => removeLessonFromCourse(lesson.$id)} disabled={removing === lesson.$id}>
