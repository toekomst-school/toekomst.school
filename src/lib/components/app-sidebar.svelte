...
<Sidebar.Root variant="floating" {...restProps}>
	<Sidebar.Header>
		<div class="flex items-center justify-center py-6">
			<img src="/toekomst_logo.svg" alt="Toekomst Logo" class="logo-invert-light h-12 w-auto" />
		</div>
	</Sidebar.Header>
	<Sidebar.Content>
		<Sidebar.Group>
	...
	<Sidebar.Footer>
		<div class="border-sidebar-border flex items-center justify-around gap-2 border-t pt-2">
			<button
				aria-label="Toggle theme"
				on:click={toggleTheme}
				class="hover:bg-sidebar-accent rounded p-2 transition-colors"
			>
				{#if theme === 'dark'}
					<SunIcon />
				{:else}
