...
<form on:submit|preventDefault={handleSubmit} class="teacher-form">
  ...
  <label>
    Kwalificaties:
    <input type="text" bind:value={qualifications} placeholder="Kwalificaties (bijv. diploma's, certificaten)" />
  </label>
  <label>
    Bio / Opmerkingen:
  ...
  <label>
    ...
    {#if photo}
      <img src={photo} alt="Foto vakdocent" style="max-width: 120px; margin-top: 0.5rem; border-radius: 0.5rem;" />
    {/if}
  </label>
