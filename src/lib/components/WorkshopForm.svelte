...
<form on:submit|preventDefault={handleSubmit}>
  ...
  <label>
    ...
    <textarea bind:value={description} rows="2" placeholder="Bijv. bijzonderheden, extra info..."></textarea>
  </label>
  <label>
    Materialen:
    <textarea bind:value={materialen} rows="2" placeholder="Bijv. laptops, robotkits, werkbladen..."></textarea>
  </label>
  <label>
    Status:
